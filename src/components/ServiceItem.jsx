...
const ServiceItem = ({ item }) => {
  return (
    <li
      ...
      items-center px-4 py-6 laptop:px-8 laptop:py-12 space-y-16 rounded-xl hover:bg-violet-700/70 
      hover:text-slate-50 hover:-translate-y-1 transition-all ease-in-out duration-300'>
      {item.icon}
