  ...
  return (
    <section className='relative py-8 tablet:py-16 shadow-md'>
      ...
      <div className="container">
        <h2 className='mb-8 tablet:mb-16 uppercase text-center text-violet-700 text-3xl font-semibold tracking-widest'>Our advantages</h2>
        <ul className='flex flex-col mobile:flex-row justify-around items-center gap-8'>
          <li className='flex flex-col w-72 items-center gap-4'>
            ...
            <p className='uppercase font-medium text-center'>Cargo handling schemes</p>
          </li>
          <li className='flex flex-col w-72 items-center gap-4'>
            <div className='bg-white shadow-md shadow-slate-400 p-8 rounded-full'>
            ...
            <p className='uppercase font-medium text-center'>Years of experience</p>
          </li>
          <li className='flex flex-col w-72 items-center gap-4'>
            <div className='bg-white shadow-md shadow-slate-400 p-8 rounded-full'>
            ...
            <p className='uppercase font-medium text-center'>Staff members</p>
          </li>
        </ul>
      </div>
    </section>
