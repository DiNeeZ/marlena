  ...
  return (
    <ul className={`${otherProps.className} text-[12px] flex-col text-sm items-end space-y-2`}>
      <li className='w-full hover:text-violet-700 ease-in duration-150'>
        <a className='flex justify-between leading-3 items-center space-x-4' href='tel:380482345355'>
          <BsFillTelephoneFill />
          <span>+38 (0482) 345 355</span>
        </a>
      </li>
      <li className='w-full hover:text-violet-700 ease-in duration-150'>
        <a className='flex justify-between leading-3 items-center space-x-4' href='mailto:marlena@renome-i.net'>
